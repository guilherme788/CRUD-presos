    ...
    <div class="main-container d-flex w-100 ">
        <div class="sidebar" id="side_nav">
            ...
            <ul class="list-unstyled px-2">
                <li class="a"><a href="index.php" class="text-decoration-none px-3 py-2 d-block fw-light"> inicio</a></li>
                <li class="active"><a href="presos.php" class="text-decoration-none px-3 py-2 d-block fw-light"> presos</a></li>
                <li class=""><a href="detidos/detidos.php" class="text-decoration-none px-3 py-2 d-block fw-light"> detidos</a></li>
                <li class=""><a href="celas/index.php" class="text-decoration-none px-3 py-2 d-block fw-light"> celas</a></li>
            </ul>
